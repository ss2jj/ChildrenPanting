	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main);
		 this.choosetv = (ViewChoose) findViewById(R.id.toolview);
	        ...
	        this.choosetv.addItem("随心涂", 17301567, new ColorClickListener(), new RoundRectDrawable(Color.argb(255, 43, 137, 219), Color.argb(255, 29, 107, 192), Color.argb(255, 30, 107, 192), Color.argb(255, 57, 157, 225), 0.5f), new RoundRectDrawable(Color.argb(205, 253, 240, 219), Color.argb(205, 250, 223, 211), Color.argb(205, 250, 203, 197), Color.argb(205, 253, 206, 200), 0.5f));
	        this.choosetv.addItem("随心画", 17301562, new DoodleClickListener(), new RoundRectDrawable(Color.argb(255, 43, 137, 219), Color.argb(255, 29, 107, 192), Color.argb(255, 30, 107, 192), Color.argb(255, 57, 157, 225), 0.5f), new RoundRectDrawable(Color.argb(205, 243, 237, 119), Color.argb(205, 219, 226, 97), Color.argb(205, 192, 217, 82), Color.argb(205, 157, 204, 59), 0.5f));
